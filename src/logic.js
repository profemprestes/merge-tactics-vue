export const ROLE_ORDER = [
  ...
  'Noble', 'Clan', 'Goblin', 'Undead', 'Fire', 'Ace', 'Titan'
];
...
export const UNIT_ATTRIBUTES = [
  ...
  { name: 'Elixir Collector', cost: 0, traits: ["Building"] },
  { name: 'Tesla', cost: 0, traits: ["Building"] },
  { name: 'Mortar', cost: 0, traits: ["Building"] }
];

export const SKILL_CONDITIONS = [
  { name: 'noble1', role: 'Noble', count: 2 },
  { name: 'noble2', role: 'Noble', count: 4 },
  { name: 'noble3', role: 'Noble', count: 6 },
  { name: 'undead1', role: 'Undead', count: 2 },
  { name: 'undead2', role: 'Undead', count: 4 },
  { name: 'undead3', role: 'Undead', count: 6 },
  { name: 'hinder1', role: 'Hinder', count: 2 },
  { name: 'hinder2', role: 'Hinder', count: 4 },
  { name: 'tank1', role: 'Tank', count: 2 },
  { name: 'tank2', role: 'Tank', count: 4 },
  { name: 'warrior1', role: 'Warrior', count: 2 },
  { name: 'warrior2', role: 'Warrior', count: 4 },
  { name: 'goblin1', role: 'Goblin', count: 2 },
  { name: 'goblin2', role: 'Goblin', count: 4 },
  { name: 'marksman1', role: 'Marksman', count: 2 },
  { name: 'marksman2', role: 'Marksman', count: 4 },
  { name: 'clan1', role: 'Clan', count: 2 },
  { name: 'clan2', role: 'Clan', count: 4 },
  { name: 'ace1', role: 'Ace', count: 2 },
  { name: 'ace2', role: 'Ace', count: 4 },
  { name: 'superstar1', role: 'Superstar', count: 2 },
  { name: 'superstar2', role: 'Superstar', count: 4 },
  { name: 'dragon1', role: 'Dragon', count: 2 },
  { name: 'titan1', role: 'Titan', count: 2 }
];
...
export function generateTeams(options) {
  ...
  for (const unitCombination of combinations(combinableUnits, unitsToPick)) {
    ...
    const roles = currentUnits.flatMap(u => u.traits || []);
